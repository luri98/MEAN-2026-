...
export const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'zaboravljena-lozinka',  loadComponent: () => import('./pages/forgotten-password/forgotten-password').then(m => m.ForgottenPassword), },
            { path: 'reset-lozinke/:token',  loadComponent: () => import('./pages/reset-password/reset-password').then(m => m.ResetPassword), },
