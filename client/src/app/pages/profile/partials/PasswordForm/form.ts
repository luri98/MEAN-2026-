...
@Component({
  ...
  <div class="h-full w-full flex flex-col p-8 bg-white rounded-2xl shadow-sm border border-gray-200">
      ...
      <div class="flex flex-col">
        ...
        <!-- Submit -->
        <button class="mt-10 w-full py-2.5 px-4 bg-teal-600 hover:bg-teal-700 text-white text-sm font-medium rounded-lg transition-colors duration-150 flex items-center justify-center gap-2"
